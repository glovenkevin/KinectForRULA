...
namespace tutorShowSkeleton
{
    public static class extension
    {
        ...
        public static Joint ScaleToNext(this Joint joint, double width, double height, float skeletonMaxX, float skeletonMaxY)
        {
        ...
        {
            return ScaleToNext(joint, width, height, 1.0f, 1.0f);
        }
